...
```
bash <(curl -sL https://raw.githubusercontent.com/darthneel/installfest_script/master/mac)
```
...
```
bash <(wget -qO- https://raw.githubusercontent.com/darthneel/installfest_script/master/ubuntu)
```
## Step 2
